...
def parse_kgat_args():
    ...
    parser.add_argument('--gpu', type=str, default='cuda:3' if torch.cuda.is_available() else 'cpu',
                        help='GPU number')

    parser.add_argument('--data_name', nargs='?', default='yahoo_movies',
                        help='Choose a dataset from {yelp2018, last-fm, amazon-book, yahoo_movies}')
    ...
    parser.add_argument('--hops', nargs='+', default=[3, 5],
                        help='Number of hops to discover the KG.')
    parser.add_argument('--num_beams', type=int, default=500,
                        help='Number of beams.')
    
    parser.add_argument('--num_llm_eval', type=int, default=1,
    ...
    parser.add_argument('--OPENAI_API_KEY', type=str,
                        help='OPENAI_API_KEY')
    parser.add_argument('--llm_model', type=str, default='gpt-3.5-turbo-0125',
                        help='llm model')
    parser.add_argument('--judge_model', type=str, default='gpt-4-turbo',
