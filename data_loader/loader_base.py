...
class DataLoaderBase(object):
    ...
    def __init__(self, args, logging):
        ...
        # self.cf_train_data: (0, 0이 좋아하는 아이템 0), (0, 0이 좋아하는 아이템 1), ...
        # self.train_user_dict: key: user_id, value: user_id가 선호하는 아이템 리스트
        self.statistic_cf()
    ...
    def generate_cf_batch(self, user_dict, batch_size):
        ...
        else: # user 수가 배치보다 작으면 중복해서 뽑는 것도 고려
    ...
    def sample_pos_triples_for_h(self, kg_dict, head, n_sample_pos_triples):
        ...
        # sample_pos_tails: head에 대응되는 entity를 n_pos_triples개 만큼 가지고 있음.
        # sample_relations: head-entity 쌍에 대응되는 relation을 n_pos_triples개 만큼 가지고 있음.
    ...
    def generate_kg_batch(self, kg_dict, batch_size, highest_neg_idx):
        ...
        for h in batch_head:
            # pos_tails: head에 대응되는 entity를 1개 만큼 가지고 있음.
            # relations: head-entity 쌍에 대응되는 relation을 1개 만큼 가지고 있음.
            relation, pos_tail = self.sample_pos_triples_for_h(kg_dict, h, 1)
            batch_relation += relation
            batch_pos_tail += pos_tail

            # highest_neg_idx: 전체 user + item + entity 수
            # neg_tails: head가 선호한 적 없는 entity를 1개 만큼 가지고 있음.
